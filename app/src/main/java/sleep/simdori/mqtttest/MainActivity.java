package sleep.simdori.mqtttest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mqttAndroidClient = new MqttAndroidClient(this,  "tcp://" + "192.168.0.21" + ":1883", MqttClient.generateClientId());
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        mqttAndroidClient.subscribe("simdori", 0 );   //연결에 성공하면 jmlee 라는 토픽으로 subscribe함
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    mqttAndroidClient.publish("simdori", "hello , success".getBytes(), 0 , false );
                    //버튼을 클릭하면 simdori 라는 토픽으로 메시지를 보냄
                } catch (MqttException e) {
                    e.printStackTrace();
                }
            }
        ...
        mqttAndroidClient.setCallback(new MqttCallback() {  //클라이언트의 콜백을 처리하는부분
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {    //모든 메시지가 올때 Callback method
                ...
                if (topic.equals("simdori")){     //topic 별로 분기처리하여 작업을 수행할수도있음
